...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: '/forecasting/olive-demand',
                name: 'OliveForecasting',
                component: () => import('@/views/forecast/OliveForecasting.vue'),
                meta: {
                  title: 'Olive Oil Demand Forecast'
                }
              }
            ...
            {
                path: '/email-compliance',
                name: 'EmailCompliance',
                component: () => import('../views/email/EmailCompliance.vue'),
                meta: {
